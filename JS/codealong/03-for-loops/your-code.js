...
let limit = 10; // We stop looping when we reach this number.
let sum = 0;    // We add even numbers to this variable.
...
let winniesFavoriteNumber = 55; // Winnie's favorite number
let kaisFavoriteNumber = 44;    // Kai's favorite number
...
for( let n=0; n <= winniesFavoriteNumber+ kaisFavoriteNumber; n++){
	if(n === winniesFavoriteNumber){
		console.log(n); 
		break;
	
	}
	if(n === kaisFavoriteNumber){
		console.log(n); 
		break;
